        ...
        <header className="mb-12 pb-8 border-b">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl md:text-4xl font-headline font-black tracking-tight leading-tight">
                Best AI Tools for <span className="brand-text-gradient italic px-1">{profession.name}</span>
              </h1>
